...
if __name__ == '__main__':
    ...
    hyp_detection_result = get_position(_hyp_detection_result)
    ...
    _hyp_detection_result = {index: data for index, data in zip(indexes, _hyp_detection_result)}
    prediction_path = os.path.join(exp_dir, 'prediction.json')
    write_json(prediction_path, _hyp_detection_result)