# input datas
TRANSCRIPTION_PATH="./datas/aishell_test_set/asr_transcription/conformer/confuse/hyp_phonetic_confuse_set"
TRANSCRIPTION_NBEST_PATH="./datas/aishell_test_set/asr_transcription/conformer/nbest"
MANSCRIPTION_PATH="./datas/aishell_test_set/asr_transcription/conformer/confuse/ref_phonetic_confuse_set"
